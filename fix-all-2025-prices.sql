...
UPDATE bitcoin_price_data SET price_usd = 125000.00 WHERE date = '2025-07-17'; -- FIXED: Was 129.054
...
UPDATE bitcoin_price_data SET price_usd = 105980.00 WHERE date = '2025-07-27'; -- FIXED: Was 129.054
...
UPDATE bitcoin_price_data SET price_usd = 125640.00 WHERE date = '2025-10-06'; -- ACTUAL ALL-TIME HIGH
...
-- ============================================================
SELECT 
  'Highest Price' as metric,
  MAX(price_usd) as value,
  date as date_of_value
FROM bitcoin_price_data
UNION ALL
SELECT 
  'Lowest Price',
  ...
  date
FROM bitcoin_price_data
WHERE price_usd = (SELECT MIN(price_usd) FROM bitcoin_price_data)
UNION ALL
SELECT
  'Total Records',
  COUNT(*),
