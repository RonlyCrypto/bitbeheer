// This Edge Function should be called by a cron job every minute
// Supabase Cron Jobs can be configured in the Supabase dashboard
// Or use external cron service like cron-job.org to call this function every minute
