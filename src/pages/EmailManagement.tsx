...
import { Mail, FileText, History, ArrowRight, CheckCircle, XCircle, Clock, Send, RefreshCw, Search, Filter, Download } from 'lucide-react';
...
export default function EmailManagement() {
  const [activeTab, setActiveTab] = useState<'templates' | 'history' | 'flow'>('templates');
  ...
  const calculateStats = (emails: EmailHistory[]) => {
    const newStats: EmailStats = {
      ...
      welcome: emails.filter(e => e.email_type === 'welcome').length,
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Beheer email templates, geschiedenis en volg het aanmeldproces</p>
                </div>
              </div>
            </div>
          </div>
                          ...
                          <td colSpan={7} className="px-4 py-8 text-center text-gray-500">
                            ...
                            <p className="text-sm mt-2">
                              {emailHistory.length === 0 
                                ? 'De email_history tabel bestaat nog niet. Voer eerst het SQL script uit.'
