...
import { Bell, X, Mail, Phone, TrendingDown, TrendingUp, Target, Settings } from 'lucide-react';
...
export default function NotificationDropdown({ unreadCount }: { unreadCount: number }) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && preferences && (
        <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-200 z-50 max-h-[600px] overflow-y-auto">
